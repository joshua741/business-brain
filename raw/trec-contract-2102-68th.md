# TREC_Contract_2102_68th

*(Converted from local file `TREC_Contract_2102_68th.pdf` by the local-files connector on 2026-06-03.)*

---

Docusign Envelope ID: D464EDBD-CB4E-473A-B558-7BE64A8AA853

Contract Concerning

Page of 11 11-04-2024

PROMULGATED BY THE(ATdEdXreAssSoRf PErAopLerEtSy)TATE COMMISSION (TREC)
...
(Seller) and KRC Services LLC and or assigned
...
3. SALES PRICE: A. Cash portion of Sales Price payable by Buyer at closing ........................... $ 116,000.00 The term “Cash portion of the Sales Price” does not include proceeds from borrowing of any kind or selling other real property except as disclosed in this contract.
...
C. Sales Price (Sum of A and B) ............................................................... $ 116,000.00
...
mineral, geothermal, water, wind, or other natural resource lease affecting the Property to which Seller is a party.
...
Initialed for identification by Buyer K
...
2102 68TH ST, LUBBOCK, TX 79412 (Address of Property)

Page 2 of 11 11-04-2024
...
Option Fee, then to the earnest money, and then to the additional earnest money. (4) Buyer authorizes Escrow Agent to release and deliver the Option Fee to Seller at any time
without further notice to or consent from Buyer, and releases Escrow Agent from liability for

delivery of the Option Fee to Seller. The Option Fee will be credited to the Sales Price at closing.
...
unrestricted right to terminate this contract by giving notice of termination to Seller within 30 days after the Effective Date of this contract (Option Period). Notices under this
...
not be refunded and Escrow Agent shall release any Option Fee remaining with Escrow Agent to Seller; and (ii) any earnest money will be refunded to Buyer.
...
Paragraph 15, or both, by providing notice to Buyer before Buyer delivers the earnest money. D. FAILURE TO TIMELY DELIVER OPTION FEE: If no dollar amount is stated as the Option Fee or if
...
provisions of the Title Policy, subject to the promulgated exclusions (including existing building and zoning ordinances) and the following exceptions: (1) Restrictive covenants common to the platted subdivision in which the Property is located.

(2) The standard printed exception for standby fees, taxes and assessments. (3) Liens created as part of the financing described in Paragraph 3. (4) Utility easements created by the dedication deed or plat of the subdivision in which the
Property is located. (5) Reservations or exceptions otherwise permitted by this contract or as may be approved by
Buyer in writing. (6) The standard printed exception as to marital rights.
...
q✔ (i) will not be amended or deleted from the title policy; or q (ii) will be amended to read, "shortages in area" at the expense of q Buyer q Seller.
(9) The exception or exclusion regarding minerals approved by the Texas Department of

Insurance.

B. COMMITMENT: Within 20 days after the Title Company receives a copy of this contract, Seller shall furnish to Buyer a commitment for title insurance (Commitment) and, at Buyer's expense, legible copies of restrictive covenants and documents evidencing exceptions in the Commitment (Exception Documents) other than the standard printed exceptions. Seller authorizes the Title

Company to deliver the Commitment and Exception Documents to Buyer at Buyer's address shown in Paragraph 21. If the Commitment and Exception Documents are not delivered to Buyer within the specified time, the time for delivery will be automatically extended up to 15 days or 3 days before the Closing Date, whichever is earlier. If the Commitment and Exception Documents are not delivered within the time required, Buyer may terminate this contract and
...
q (1) Buyer has received the Notice. q (2) Buyer has not received the Notice. Within
...
(Check one box only)
q✔ (1) Buyer accepts the Property As Is. q (2) Buyer accepts the Property As Is provided Seller, at Seller’s expense, shall complete the
...
required condition, ordinary wear and tear excepted: q✔ upon closing and funding qaccording
to a temporary residential lease form promulgated by TREC or other written lease required by the parties. Any possession by Buyer prior to closing or by Seller after closing which is not authorized by a written lease will establish a tenancy at sufferance relationship between the parties. Consult your insurance agent prior to change of ownership and possession because insurance coverage may be limited or terminated. The absence of a written lease or appropriate insurance coverage may expose the parties to economic loss. B. SMART DEVICES: “Smart Device” means a device that connects to the internet to enable remote use, monitoring, and management of: (i) the Property; (ii) items identified in any NonRealty Items Addendum; or (iii) items in a Fixture Lease assigned to Buyer. At the time Seller delivers possession of the Property to Buyer, Seller shall: (1) deliver to Buyer written information containing all access codes, usernames, passwords,
and applications Buyer will need to access, operate, manage, and control the Smart Devices; and (2) terminate and remove all access and connections to the improvements and accessories from any of Seller’s personal devices including but not limited to phones and computers.
...
In the event the Buyer elects to terminate this contract within the option period, the Option Fee shall be refunded
...
or q _____% of the Sales Price (check one box only); and

(c) an amount not to exceed $

to be applied to other Buyer’s Expenses.
...
E-mail/Fax: With a copy to Buyer’s agent at:
...
E-mail/Fax: With a copy to Seller’s agent at:
...
q Third Party Financing Addendum q Seller Financing Addendum q Addendum for Property Subject to
Mandatory Membership in a Property Owners Association

q Seller’s Temporary Residential Lease q Short Sale Addendum q Addendum for Property Located Seaward
...
q Addendum for Sale of Other Property by
Buyer
...
q Addendum for Seller's Disclosure of
Information on Lead-based Paint and Lead-based Paint Hazards as Required by Federal Law
q Addendum for Property in a Propane Gas
System Service Area
q Addendum Regarding Residential Leases q Addendum Regarding Fixture Leases
q Addendum containing Notice of Obligation
...
q Addendum for Section 1031 Exchange q Other (list):
...
E-mail: Initialed for identification by Buyer K
...
Page 9 of 11 11-04-2024

EXECUTED the 21st day of

August

, 20 25 (Effective Date).
...
q Buyer only as Buyer’s agent q Seller as Listing Broker’s subagent
...
q Seller and Buyer as an intermediary q Seller only as Seller’s agent

Associate’s Name

License No. Listing Associate’s Name

License No.

Team Name Associate’s Email Address

Team Name Phone Listing Associate’s Email Address
...
License No. Licensed Supervisor of Listing Associate

License No.

Phone Listing Broker’s Office Address
...
Selling Associate’s Name Team Name Selling Associate’s Email Address Licensed Supervisor of Selling Associate Selling Associate’s Office Address
...
Page 11 of 11 11-04-2024

OPTION FEE RECEIPT
Receipt of $___________________ (Option Fee) in the form of _____________________________________ is acknowledged.
...
Receipt of $____________________ Earnest Money in the form of is acknowledged.
...
Receipt of $__________________ additional Earnest Money in the form of ____________________________ is acknowledged.
