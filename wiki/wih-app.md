...
- **Property listing data for Vince / AI blast** — store per-property details (beds, baths, sell price, RTO deposit, SF down, monthly payment, property slug, photo URL) in the app so the AI pulls live data when sending blasts instead of using hardcoded placeholders. One record per active listing; updated when a new property goes live.
